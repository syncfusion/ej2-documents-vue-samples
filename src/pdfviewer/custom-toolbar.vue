<template>
    ...
    <ejs-toolbar id="form-toolbar">
      <e-items>
        ...
        <e-item id="formField_checkbox" prefixIcon="e-icons-new e-check-box" :click='checkBox' tooltipText="Checkbok" align="Center"></e-item>
  ...
  methods: {
    ...
    checkSearchActive: function () {
      if(!this.searchActive) {
        viewer.viewerBase.clearAllTextSearchOccurrences();
      }
    },
