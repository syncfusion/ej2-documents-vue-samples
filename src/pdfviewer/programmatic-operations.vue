    ...
    <div id="description">
      <p>
        ...
        programmatically add any type of annotation using the <a target="_blank"
          href="https://helpej2.syncfusion.com/vue/documentation/api/pdfviewer/annotation/#addannotation">addAnnotation</a> API
      ...
      <ul>
        <li>
          <a target="_blank"
            href="https://help.syncfusion.com/document-processing/pdf/pdf-viewer/vue/annotation/text-markup-annotation">Text markup
            annotations</a>
        </li>
        <li>
          <a target="_blank"
            href="https://help.syncfusion.com/document-processing/pdf/pdf-viewer/vue/annotation/shape-annotation">Shape
            annotations</a>
        </li>
        <li>
          <a target="_blank"
            href="https://help.syncfusion.com/document-processing/pdf/pdf-viewer/vue/annotation/measurement-annotation">Measurements
            annotations</a>
        </li>
        <li>
          <a target="_blank"
            href="https://help.syncfusion.com/document-processing/pdf/pdf-viewer/vue/annotation/free-text-annotation">Free text
            annotations</a>
        </li>
        <li>
          <a target="_blank"
            href="https://help.syncfusion.com/document-processing/pdf/pdf-viewer/vue/annotation/stamp-annotation">Stamp
            annotations</a>
        </li>
        <li>
          <a target="_blank" href="https://help.syncfusion.com/document-processing/pdf/pdf-viewer/vue/annotation/ink-annotation">Ink
            annotations</a>
        </li>
        <li>
          <a target="_blank"
            href="https://help.syncfusion.com/document-processing/pdf/pdf-viewer/vue/annotation/sticky-notes-annotation">Sticky notes
            annotations</a>
        </li>
      </ul>
      <p>
...
export default {
  ...
  data: function () {
    return {
      ...
      pdfviewerApiPath: {
        saveUrl:
          "https://document.syncfusion.com/web-services/pdf-viewer/api/FileUploader/Save",
        removeUrl:
          "https://document.syncfusion.com/web-services/pdf-viewer/api/FileUploader/Remove",
      },
