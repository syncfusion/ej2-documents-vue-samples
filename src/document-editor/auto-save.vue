...
<div class="flex-container">
    ...
    <div id="description">
        ...
        <p style="display: block"> More information about the document editor features can be found in this
            <a target="_blank" href="https://help.syncfusion.com/document-processing/word/word-processor/vue/how-to/auto-save-document-in-document-editor/">documentation section.</a>
        </p>
    </div>
</div>
</template>
