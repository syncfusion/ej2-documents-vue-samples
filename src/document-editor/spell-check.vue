<template>
  <div>
    <div class="row">
      ...
      <div class="col-lg-2 property-section">
          <div class="heading-section">
            <h5><b>Spell checker settings</b></h5>
          </div>

          <div class="content-wrapper">
            <ejs-dropdownlist id='ddlelement' :dataSource='languageData' :fields='fields' :value='currentLanguage'  :change='onLanguageChange'></ejs-dropdownlist>
          </div><br>
    ...
    <div id="action-description">
      <p>
        This example demonstrates the built-in spell checking functionality in the Document Editor. You can enable or disable spell checking, configure underline display and suggestion visibility.
      </p>
    </div>
    <div id="description">
      <p>
        This example showcases the comprehensive spell‑checking capabilities of the Document Editor, including:
      </p>
      <ul>
        <li>
          Real-time error detection to identify misspelled words as you type.
        </li>
        <li>
          A toggle option to enable or disable spell checking.
        </li>
        <li>
          The ability to show or hide wavy underlines for misspelled words.
        </li>
        <li>
          Options to display or hide spelling suggestions for corrections.
        </li>
      </ul>
      <p style="display: block">
        ...
        <a
          target="_blank"
          href="https://help.syncfusion.com/document-processing/word/word-processor/vue/spell-check/"
  ...
  import { spellCheckData } from './data';
  ...
  export default {
    ...
    methods: {
      ...
      onLanguageChange: function(e) {
        ...
        obj.spellChecker.languageID = e.value;
        var langData;
        if (obj.spellChecker.languageID === 1033) {
          langData = JSON.stringify(spellCheckData.englishSfdt);
        } else {
          langData = JSON.stringify(spellCheckData.spanishSfdt);
        }
        obj.open(langData);
      },
      ...
      onSelectionChangedEvent: function () {
            var obj = this.$refs.doceditcontainer.ej2Instances.documentEditor;
            if (obj.spellChecker.enableSpellCheck !== this.$refs.enableSpelling.ej2Instances.checked) {
            this.$refs.enableSpelling.ej2Instances.checked = obj.spellChecker.enableSpellCheck;
            this.$refs.showSuggestions.ej2Instances.disabled =
            this.$refs.showUnderline.ej2Instances.disabled =
              !this.$refs.enableSpelling.ej2Instances.checked;
            }
            if (obj.spellChecker.removeUnderline === this.$refs.showUnderline.ej2Instances.checked) {
              this.$refs.showUnderline.ej2Instances.checked = !obj.spellChecker.removeUnderline;
            }
        },
      changeEnableSpelling: function (args) {
        this.$refs.doceditcontainer.ej2Instances.documentEditor.spellChecker.enableSpellCheck = args.checked;
        const isDisabled = !args.checked;
        this.$refs.showUnderline.ej2Instances.disabled = isDisabled;
        this.$refs.showSuggestions.ej2Instances.disabled = isDisabled;
      },
      changeShowUnderline: function (args) {
        this.$refs.doceditcontainer.ej2Instances.documentEditor.spellChecker.removeUnderline = !args.checked;
      },
      changeShowSuggestions: function (args) {
        this.$refs.doceditcontainer.ej2Instances.documentEditor.spellChecker.allowSpellCheckAndSuggestion = args.checked;
      },
    },
    mounted() {
      this.$nextTick(function () {
        var obj = this.$refs.doceditcontainer.ej2Instances.documentEditor;
        obj.open(JSON.stringify(spellCheckData.englishSfdt));
        obj.documentName = 'Getting Started';
        obj.spellChecker.languageID = 1033;
        obj.spellChecker.removeUnderline = false;
        obj.spellChecker.allowSpellCheckAndSuggestion = true;
        this.$refs.doceditcontainer.ej2Instances.selectionChange = () => {
