...
<div id="description">
    ...
    <p style="display: block">More information about the document editor features can be found in this <a target="_blank" href="https://help.syncfusion.com/document-processing/word/word-processor/vue/section-format/">documentation section.</a>
    </p>
</div>
  </div>
</template>
